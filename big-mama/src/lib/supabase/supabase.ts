...
export async function createSupabaseFrontendClient() {
    ...
    if (url && key) {
        ...
        throw error("missing supabase url,please add NEXT_PUBLIC_SUPABASE_URL variable to .env file. please, refer to the README.md # Authentication section")
    } else if (!key) {
        throw error("missing supabase url,please add NEXT_PUBLIC_SUPABASE_ANON_KEY variable to .env file. please, refer to the README.md # Authentication section")
    }
